...
<body>
  <div class="header">
    ...
    <ul class="layui-nav header-down-nav">
      ...
      <li class="layui-nav-item"><a href="addNote.ftl">留言</a></li>
              ...
              <div class="form-box">
                <div class="article-cont">
                  <div class="title">
                    ...
                    <p class="cont-info"><span class="data">${(notes.noteTime?string("yyyy-MM-dd"))!}</span><span class="types">${notes.noteType}</span><span class="types">${notes.noteSource}</span></p>
                  </div>
                  <p>${notes.noteBody}</p>
                  <div class="btn-box">
                    <a href="/del?id=#{notes.noteId}"><button class="layui-btn layui-btn-primary">删除</button></a>
                      <a href="/update?id=${notes.noteId}"> <button class="layui-btn layui-btn-primary">修改</button></a>
                  </div>
                </div>
                <div class="form">
